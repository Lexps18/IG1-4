...
setup_windows_console()
{
	...
	// Console output with ANSI escape sequences (color, etc.)
...
main(int argc, char* argv[])
{
	...
	// Activar detección de leaks al salir del proceso completo (incluyendo
	// destructores estáticos), en lugar de llamar a _CrtDumpMemoryLeaks()
	// manualmente. Así se evitan falsos positivos del singleton IG1App y
	// del mapa de shaders, cuyos destructores se ejecutan DESPUÉS de main().
